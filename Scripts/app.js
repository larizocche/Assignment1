...
(function () {
    ...
    var resume = [];
    //index page - each element has a number, known as an index, it represents the element's position within the array.
    ...
    //define your paragraphs array - create an empty array first
    var resumeData = [];
    //data for the main page - assigning value to individual array elements.
